      ...
      <div className="container mx-auto px-4 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 text-center md:text-left mb-12">
          ...
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-xl font-luxury text-cream mb-6">Quick Links</h4>
          ...
          {/* Right */}
          <div className="flex flex-col items-center md:items-start">
            <h4 className="text-xl font-luxury text-cream mb-6">Follow Us</h4>
        ...
        <div className="border-t border-gold/10 pt-8 text-center">
          <p className="text-cream/50 font-body text-sm">
            &copy; {new Date().getFullYear()} KS Decors. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
